...
"""
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("Снайпер — 2 подсказки\n   Никто не получил", report)
            self.assertIn("Король раунда «Финал» — 1 подсказка\n   Никто не получил", report)
            self.assertIn("Идеальный баланс — 1 подсказка", report)
