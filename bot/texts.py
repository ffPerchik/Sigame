...
NEW_PLAYER_GATE = "🆕 Новый игрок: {name} (@{username}) — ждёт старта."
GATE_APPROVED = "✅ Игрок {uid} запущен!"
GATE_REJECTED_HOST = "❌ Игрок {uid} отклонён."
...
# ============ ГЕЙТ ============
IN_GATE = "⏳ Ожидай, пока ведущий подтвердит старт."
GATE_REJECTED = "❌ Ведущий отклонил твой старт. Свяжись с ним лично."
...
PROGRESS_GATE = "⏳ Ты пока не запущен. Жди, пока ведущий подтвердит старт."
...
HUB_HEADER = (
    "┌─  ARGVS-1001 · ХАБ  ─┐\n"
    "\n"
    "Шесть узлов. В каждом — несколько слоёв.\n"
    "Каждый узел отдаёт один фрагмент послания.\n"
    "\n"
    "Порядок любой. Один приём — это ещё не узел."
)
