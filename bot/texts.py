...
PLAYER_HELP = (
    ...
    "Команды: /progress — твой прогресс, /hub — вернуться к хабу, /hint — взять подсказку, /help."
)
ADMIN_HELP = (
    "Команды ведущего:\n"
...
QUEST_GATE_HOST = "🔒 {name} [id:{uid}] прошёл пролог и ждёт запуска основного квеста."
GATE_APPROVED = "✅ Игроку {uid} открыт основной квест."
GATE_REJECTED_HOST = "🔒 Основной квест для игрока {uid} оставлен закрытым."
...
# ============ ГЕЙТ ============
IN_GATE = "🔒 Пролог завершён. Основной квест откроется по сигналу ведущего."
GATE_REJECTED = "🔒 Основной квест пока не открыт. Ожидай сигнала ведущего."
...
PROGRESS_GATE = "🔒 Пролог пройден. Ты ждёшь открытия основного квеста."
...
HUB_HEADER = (
    "┌─  ARGVS-1001 · ХАБ  ─┐\n"
    "\n"
    "Женя здесь больше не пишет.\n"
    "Шесть узлов, порядок любой. Один слой — мало."
)
