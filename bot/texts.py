...
ADMIN_HELP = (
    ...
    "/setstage <@username или id> <stage_id> — перевести игрока вручную\n"
    "/msg <@username или id> <текст> — личное сообщение игроку\n"
    "/broadcast <текст> — сообщение всем\n"
    "/reset <@username или id> — сбросить игрока в начало\n"
...
NODE_SHORT = {
    ...
    "N3": "бумажные шифры · несколько связанных листов",
    "N4": "видео · поиск незаметных деталей",
    "N5": "числовая логика · данные внутри файла",
    "N6": "цепочка шифров · бумага, видео, точки и строки · откроется после пяти",
}
...
PENDING_HEADER = "⏳ Сабмиты на проверке:"
...
SETSTAGE_USAGE = "/setstage <@username или id> <stage_id>"
...
RESET_USAGE = "/reset <@username или id>"
...
HUB_HEADER = (
    "┌─  ARGVS-1001 · ХАБ  ─┐\n"
    "\n"
    "Шесть узлов. Первые пять — в любом порядке, шестой откроется после них."
)
HUB_LINE_DONE = "  ▰  {n}. {label}    ·  {hint}  ·  пройден"
HUB_LINE_TODO = "  ▱  {n}. {label}    ·  {hint}  ·  не начат"
HUB_LINE_LOCKED = "  🔒  {n}. {label}    ·  {hint}"
