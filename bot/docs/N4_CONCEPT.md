...
Хронология в ролике строго последовательна: hex-сбои (первая половина) →
буквенные сбои (11–17 c) → ловушка (17 c) → метка (конец) — шаг N нельзя
встретить раньше шага N-1.
...
Фрагмент: **АПЕРТУРА** (слова-ключи из смерженной ветки) (как раньше).
